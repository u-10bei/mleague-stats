...
with tab1:
    ...
    if not players_df.empty:
        ...
        # カラム名を変更
        display_df.columns = ["player_id", "選手名", "所属チーム", "season"]
        display_df = display_df[["選手名", "所属チーム"]]
...
with st.expander("📊 データベース統計"):
    ...
    if not players_df.empty:
        ...
        with col3:
            retired_players = total_players - active_count
            st.metric("登録のみ", f"{retired_players}名")
